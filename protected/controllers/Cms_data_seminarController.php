...
class Cms_data_seminarController extends Controller
{
	...
	public function actionCreate($id)
	{
		...
		if(isset($_POST['Seminar']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_seminar));
		}
	 ...
	 * @param Seminar $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='seminar-form')
		{
