...
class Cms_data_riwayat_pangkatController extends Controller
{
	...
	public function actionCreate($id)
	{
		...
		if(isset($_POST['RiwayatPangkat']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_riwayat_pangkat));
		}
	 ...
	 * @return RiwayatPangkat the loaded model
	 ...
	 * @param RiwayatPangkat $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='riwayat-pangkat-form')
		{
