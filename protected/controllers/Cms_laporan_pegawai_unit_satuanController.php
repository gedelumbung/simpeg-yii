...
class Cms_laporan_pegawai_unit_satuanController extends Controller
{
	...
	{
		$where = '';
		if($_SESSION['lap_1_id_satuan_kerja']=="Semua" || $_SESSION['lap_1_id_satuan_kerja']=="" && $_SESSION['lap_1_id_unit_kerja']=="Semua" || $_SESSION['lap_1_id_unit_kerja']=="")
		{
			$where = '';
		}
		else if($_SESSION['lap_1_id_satuan_kerja']=="Semua" || $_SESSION['lap_1_id_satuan_kerja']=="")
		{
			$where = 'where a.id_unit_kerja = "'.$_SESSION['lap_1_id_satuan_kerja'].'" ';
		}
		else if($_SESSION['lap_1_id_unit_kerja']=="Semua" || $_SESSION['lap_1_id_unit_kerja']=="")
		{
			$where = 'where a.id_satuan_kerja = "'.$_SESSION['lap_1_id_satuan_kerja'].'" ';
		}
		else
		{
			$where = 'where a.id_satuan_kerja = "'.$_SESSION['lap_1_id_satuan_kerja'].'" and a.id_unit_kerja = "'.$_SESSION['lap_1_id_satuan_kerja'].'"';
		}
	...
	public function actionIndex()
	{
		...
		$_SESSION['lap_1_id_unit_kerja'] = isset($_SESSION['lap_1_id_unit_kerja']) ? $_SESSION['lap_1_id_unit_kerja'] : 'Semua';
		$_SESSION['lap_1_id_satuan_kerja'] = isset($_SESSION['lap_1_id_satuan_kerja']) ? $_SESSION['lap_1_id_satuan_kerja'] : 'Semua';

		if(isset($_GET['Pegawai']))
		{
			$model->attributes=$_GET['Pegawai'];
			$_SESSION['lap_1_id_unit_kerja'] = isset($_GET['Pegawai']['id_unit_kerja']) ? $_GET['Pegawai']['id_unit_kerja'] : 'Semua';
			$_SESSION['lap_1_id_satuan_kerja'] = isset($_GET['Pegawai']['id_satuan_kerja']) ? $_GET['Pegawai']['id_satuan_kerja'] : 'Semua';
		}
