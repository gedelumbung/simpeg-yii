...
class Cms_laporan_pegawai_status_golonganController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$_SESSION['lap_4_status_pegawai'] = isset($_SESSION['lap_4_status_pegawai']) ? $_SESSION['lap_4_status_pegawai'] : 'Semua';
		$_SESSION['lap_4_id_golongan'] = isset($_SESSION['lap_4_id_golongan']) ? $_SESSION['lap_4_id_golongan'] : 'Semua';
		$_SESSION['lap_4_id_satuan_kerja'] = isset($_SESSION['lap_4_id_satuan_kerja']) ? $_SESSION['lap_4_id_satuan_kerja'] : 'Semua';

		if(isset($_GET['Pegawai']))
		{
			$model->attributes=$_GET['Pegawai'];
			$_SESSION['lap_4_status_pegawai'] = isset($_GET['Pegawai']['status_pegawai']) ? $_GET['Pegawai']['status_pegawai'] : 'Semua';
			$_SESSION['lap_4_id_golongan'] = isset($_GET['Pegawai']['id_golongan']) ? $_GET['Pegawai']['id_golongan'] : 'Semua';
			$_SESSION['lap_4_id_satuan_kerja'] = isset($_GET['Pegawai']['id_satuan_kerja']) ? $_GET['Pegawai']['id_satuan_kerja'] : 'Semua';
		}
	...
	{
		$where = '';
		if($_SESSION['lap_4_id_satuan_kerja']=="Semua" || $_SESSION['lap_4_id_satuan_kerja']=="" && $_SESSION['lap_4_id_golongan']=="Semua" || $_SESSION['lap_4_id_golongan']=="" && $_SESSION['lap_4_status_pegawai']=="Semua" || $_SESSION['lap_4_status_pegawai']=="")
		{
			$where = '';
		}
		else
		{
			$where = 'where a.id_satuan_kerja = "'.$_SESSION['lap_4_id_satuan_kerja'].'" and a.id_golongan = "'.$_SESSION['lap_4_id_golongan'].'" and a.status_pegawai = "'.$_SESSION['lap_4_status_pegawai'].'"';
		}
