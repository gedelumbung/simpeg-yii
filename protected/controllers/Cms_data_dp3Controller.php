...
class Cms_data_dp3Controller extends Controller
{
	...
	{
		$model=new Dp3('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Dp3']))
			$model->attributes=$_GET['Dp3'];
	 ...
	 * @return Dp3 the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Dp3::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Dp3 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='dp3-form')
		{
