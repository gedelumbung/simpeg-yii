...
class Cms_data_riwayat_jabatanController extends Controller
{
	...
	public function actionCreate($id)
	{
		...
		if(isset($_POST['RiwayatJabatan']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_riwayat_jabatan));
		}
	 ...
	 * @param RiwayatJabatan $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='riwayat-jabatan-form')
		{
