...
/**
 * This is the model class for table "tbl_master_golongan".
 *
 * The followings are the available columns in table 'tbl_master_golongan':
...
class Golongan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('golongan, uraian, level', 'required'),
			array('golongan', 'length', 'max'=>100),
			array('level', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_golongan, golongan, uraian, level', 'safe', 'on'=>'search'),
		);
	}
