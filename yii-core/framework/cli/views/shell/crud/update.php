...
$this->menu=array(
	...
	array('label'=>'View <?php echo $this->class2name($modelClass,true); ?>', 'url'=>array('view', 'id'=>$model-><?php echo $ID; ?>)),
	array('label'=>'Manage <?php echo $this->class2name($modelClass,true); ?>', 'url'=>array('admin')),
);
?>

<h1>Update <?php echo $this->class2name($modelClass,true)." <?php echo \$model->{$ID}; ?>"; ?></h1>
